...
class DeadlinePressureScore:
    """Puntúa por urgencia: atiende primero lo que está más cerca del vencimiento y en períodos escasos.
...
def build_component(problem, deadline_weight: float = 1.0, scarcity_weight: float = 1.0, future_hardness_weight: float = 1.0):
