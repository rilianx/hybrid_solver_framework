...
class TwoCustomerChainMergeNeighborhood:
        ...
        if p == 0:
            ...
            for r in routes:
                ...
                if r and r[-1] == p and n == 0:
                    r.append(c)
                    return
        # Fallback for degenerate/canonical-safe reconstruction
        routes.append([c])
    ...
    def apply(self, sol, m):
        ...
        # Remove both customers from their original positions.
    ...
    def undo(self, sol, m):
        ...
        # Restore the original two customers using their recorded contexts.
        # If they were adjacent in the same route, the context order determines the safe insertion order.
        if na == b:
