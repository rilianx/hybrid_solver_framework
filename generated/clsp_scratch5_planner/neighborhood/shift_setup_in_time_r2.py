...
class ShiftSetupInTime:
    ...
    def moves(self, sol: Solution) -> Iterable[tuple]:
    ...
    def apply(self, sol: Solution, m: tuple) -> Solution:
        i, t, direction = m
        t2 = t + direction
    ...
    def undo(self, sol: Solution, m: tuple) -> Solution:
        i, t, direction = m
        t2 = t + direction
        rows = [list(r) for r in sol]
        rows[i][t] = True
    ...
    def delta(self, sol: Solution, m: tuple) -> float:
