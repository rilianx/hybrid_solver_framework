...
class RedundantSetupPruner:
    ...
    Movimiento: (i, t) significa alternar el setup del ítem i en el período t.
    La prioridad es proponer eliminaciones redundantes; si no existen, se
    garantiza vecindario no vacío con flips elementales.
    """
