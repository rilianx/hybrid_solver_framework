...
class RedundantSetupPruner:
    ...
    con undo. Se propone el movimiento solo cuando el ítem ya tiene otro setup previo
    dentro de la ventana lookback_limit, manteniendo la idea de eliminar setups
    ...
    def moves(self, sol):
        ...
        limit = min(self.lookback_limit, n_periods - 1)
